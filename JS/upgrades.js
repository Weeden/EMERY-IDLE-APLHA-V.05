...
function upgradeHatchet() { //upgrade your Hatchet
    if (bank.money >= woodcutting.upgradeHatchet) {
      ...
      update("moneyMade", bank.money + " coins left.")
  ...
  function upgradePickaxe()  { //upgrade pickaxe
    if  (mining.rock >= mining.rockPerClickCost)  {
      mining.rock -= mining.rockPerClickCost
  ...
  function upgradeFishingPole()  { //upgrade fishing pole
    if  (fishing.fish >= fishing.fishPerClickCost)  {
      fishing.fish -= fishing.fishPerClickCost
